        ...
        <div className="text-center max-w-6xl mx-auto space-y-10">
          ...
          <div className="relative mb-10">
            ...
            >
              {user ? (
                <>
                  <span className="block text-4xl lg:text-6xl xl:text-7xl mb-4 text-white/80">
                    Welcome back,
                  </span>
                  ...
                  <span className="block text-3xl lg:text-5xl xl:text-6xl mt-6 text-gradient">
                ...
                <>
                  ...
                  <span className="block text-4xl lg:text-6xl xl:text-7xl mt-4 bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">
          ...
          <p 
            className="text-xl lg:text-2xl text-gray-300 mb-14 leading-relaxed max-w-4xl mx-auto animate-fade-in"
            style={{
          ...
          <div 
            className="flex flex-col sm:flex-row gap-8 justify-center mb-20 animate-fade-in"
            style={{
          ...
          >
            <Button 
              ...
              size="lg" 
              className="group relative bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold text-lg px-12 py-8 rounded-2xl shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 hover:scale-105 transform-gpu border-0 overflow-hidden"
            >
          ...
          {!user && (
            <div 
              className="grid grid-cols-2 lg:grid-cols-4 gap-10 animate-fade-in"
              style={{
                transform: `translateY(${scrollY * 0.01}px)`,
                animationDelay: '0.6s',
              }}
            >
              {stats.map((stat, index) => (
                <div key={index} className="group">
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="flex flex-col items-center">
                      <stat.icon className={`w-8 h-8 ${stat.color} mb-3 group-hover:scale-110 transition-transform duration-300`} />
                      <div className="text-3xl font-bold text-white mb-1 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 transition-all duration-300">
                        {stat.value}
                      </div>
